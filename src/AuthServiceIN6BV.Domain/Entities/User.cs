...
public class User
{
    ...
    [MaxLength(25, ErrorMessage = "El apellido no puede superar los 25 caracteres.")]
    public string Surname { get; set; } = string.Empty;

    [Required(ErrorMessage = "El nombre de usuario es obligatorio.")]
    [MaxLength(25, ErrorMessage = "El nombre de usuario no puede superar los 25 caracteres.")]
